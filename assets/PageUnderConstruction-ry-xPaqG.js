import{r as o,j as s}from"./index-BA2eECHz.js";/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const k=[["path",{d:"M10 10V5a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v5",key:"1p9q5i"}],["path",{d:"M14 6a6 6 0 0 1 6 6v3",key:"1hnv84"}],["path",{d:"M4 15v-3a6 6 0 0 1 6-6",key:"9ciidu"}],["rect",{x:"2",y:"15",width:"20",height:"4",rx:"1",key:"g3x8cw"}]],b=m("hard-hat",k);function A(){return s.jsx("div",{className:"min-h-screen  flex  items-center justify-center bg-base-100 text-center px-4",children:s.jsxs("div",{className:"max-w-md space-y-4",children:[s.jsx("div",{className:"text-warning",children:s.jsx(b,{className:"w-16 h-16 mx-auto"})}),s.jsx("h1",{className:"text-3xl font-bold",children:"test 2 Page en cours de développement"}),s.jsx("p",{className:"text-base-content",children:"Cette fonctionnalité est actuellement en construction. Nous travaillons dur pour la rendre disponible bientôt."}),s.jsxs("div",{className:"flex items-center justify-center gap-2 text-sm text-base-content",children:[s.jsx(j,{className:"w-4 h-4"}),s.jsx("span",{children:"Merci de votre patience."})]})]})})}export{A as default};
